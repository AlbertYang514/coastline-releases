...
- macOS：`Coastline-1.3.0.dmg`
- Windows：`CoastlineSetup-1.3.0-win-x64.exe`
...
1. 下载 `CoastlineSetup-1.3.0-win-x64.exe`。
2. 运行安装包。
3. 按安装向导完成安装。
...
1. Download `Coastline-1.3.0.dmg`.
2. Open the DMG file.
...
1. Download `CoastlineSetup-1.3.0-win-x64.exe`.
2. Run the installer.
